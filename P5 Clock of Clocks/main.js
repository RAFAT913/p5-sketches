...
function draw() {
  ...
  s1.displayed = hr.toString().charAt(0)
  s2.displayed = hr.toString().charAt(1)

  s4.displayed = mn.toString().charAt(0)
  s5.displayed = mn.toString().charAt(1)

  s7.displayed = sec.toString().charAt(0)
  s8.displayed = sec.toString().charAt(1)
}
